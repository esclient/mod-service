...
class TestModService:
    ...
    def test_generate_upload_url(self, mod_service, mock_s3_service):
        ...
        mock_s3_service.generate_upload_url.return_value = (expected_s3_key, expected_url)
    ...
    def test_get_file_info_from_s3_key(self, mod_service, mock_s3_service):
        ...
        mock_s3_service.get_file_info_from_s3_key.assert_called_once_with(s3_key)
    ...
    def test_create_mod_delegates_to_repository(self, mod_service, mock_repo):
        ...
        with pytest.MonkeyPatch().context() as m:
            m.setattr("modservice.service.service._create_mod", lambda *args: expected_result)
            
            result = mod_service.create_mod(mod_title, author_id, filename, description)
