...
class S3Service:
    ...
    def generate_upload_url(
        ...
        logger.info(f"Генерируем Presigned PUT URL для автора {author_id}, файл: {filename}")
    ...
    def generate_upload_url_for_key(
        ...
        logger.info(f"Генерируем Presigned PUT URL для существующего s3_key: {s3_key}")
